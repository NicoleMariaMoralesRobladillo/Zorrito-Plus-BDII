      ...
      <div class="row align-items-center justify-content-center">
        ...
        <div class="col-12 col-md-6 mb-3 m-md-0 d-flex justify-content-center order-0 order-md-1">
          <div class="formulario p-5 rounded-4 w-100">
            <form class="d-flex flex-column" method="post" @submit.prevent="iniciarSesion">
              <h1 class="text-white fs-1 text-center lh-base pb-3 m-0 fw-bold text-uppercase">
                Iniciar sesión
              </h1>
              <img src="../assets/images/user.png" alt="Ícono de usuario" class="py-3 user-icon m-auto w-100" />
              <label for="correoIniciarSesion" class="text-white fs-5 text-start lh-base py-3">Correo</label>
              <input type="email" id="correoIniciarSesion" name="correoIniciarSesion"
                v-model="usuarioIniciarSesion.Correo" class="formulario__input border-0 rounded-pill py-2 px-3"
                required />
              <label for="contraseniaIniciarSesion" class="text-white fs-5 text-start lh-base py-3">Contraseña</label>
              <input type="password" id="contraseniaIniciarSesion" name="contraseniaIniciarSesion"
                v-model="usuarioIniciarSesion.Contrasenia" class="formulario__input border-0 rounded-pill py-2 px-3"
                required />
              ...
              <router-link to="/registrate" class="fs-5 text-center lh-base pb-2 formulario__link">Regístrate
              </router-link>
            </form>
          </div>
        </div>
